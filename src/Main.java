...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int squareLen = n; squareLen>=0; squareLen--) {
	...
	private static boolean trySquare(int squareLen) {
		// TODO Auto-generated method stub
		for (int x=0;x<n;x++) {
			for (int y=0;y<n;y++) {
	...
	private static boolean tryPosLen(Position pos, int squareLen) {
		// TODO Auto-generated method stub
